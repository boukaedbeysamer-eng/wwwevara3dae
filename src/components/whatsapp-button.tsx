...
export function WhatsAppButton() {
  ...
  return (
    <a
      href="https://wa.me/971553949060"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat with us on WhatsApp"
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/25 transition-transform duration-200 hover:scale-110 animate-whatsapp-pulse md:bottom-6 md:right-6 md:h-16 md:w-16"
    >
      <svg
        viewBox="0 0 24 24"
        fill="white"
